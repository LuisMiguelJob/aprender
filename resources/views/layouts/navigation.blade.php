  <aside
        ...
        <div class="py-4 text-gray-500 dark:text-gray-400">
          ...
          @auth
            <ul class="mt-6">
              <li class="relative px-6 py-3">
                ...
                <a
                  ...
                  href="/inicio" {{-- Notar que se uso para redirigir a inicio --}} 
                >
                  <svg
                    class="w-5 h-5"
                    aria-hidden="true"
            ...
            <ul>
              <li class="relative px-6 py-3"> {{-- FORMS, al parecer inicio es un bloque separado, y aqui es otro con los demas botones --}} 
              ...
              {{-- Ejemplo de un elemento de una tabla, usar si se quieren agregar mas
              <li class="relative px-6 py-3">
                <a
                  class="inline-flex items-center w-full text-sm font-semibold transition-colors duration-150 hover:text-gray-800 dark:hover:text-gray-200"
                  href="../tables.html"
