...
{{-- src="{{ asset('windmill/js/init-alpine.js') }}" --}}
</head>
    ...
    <div class="flex items-center min-h-screen p-6 bg-gray-50 dark:bg-gray-900">
        ...
        <div class="flex flex-col overflow-y-auto md:flex-row">
            ...
            <img
                ...
                src="{{ asset('windmill/img/create-account-office.jpeg') }}"
                alt="Office"
            />
            <img
                aria-hidden="true"
                class="hidden object-cover w-full h-full dark:block"
                src=" {{ asset('/windmill/img/create-account-office-dark.jpeg') }}"
                alt="Office"
            />
            </div>
            ...
            <div class="w-full">
                ...
                @csrf
                    ...
                    <label class="block text-sm">
                        ...
                        <input
                            type="text"
                            class="block w-full mt-1 text-sm dark:text-gray-300 dark:bg-gray-700 focus:outline-none form-input @error('name') border-red-600 focus:border-red-400 focus:shadow-outline-red @endif"
                    ...
                    <label class="block text-sm">
                        ...
                        <input
                            type="email"
                            class="block w-full mt-1 text-sm dark:text-gray-300 dark:bg-gray-700 focus:outline-none form-input @error('email') border-red-600 focus:border-red-400 focus:shadow-outline-red @endif"
                    ...
                    {{-- codigo --}}
                    <label class="block text-sm">
                        <span class="text-gray-700 dark:text-gray-400">Codigo alumno/trabajador</span>
                        <input
                            type="number"
                            class="block w-full mt-1 text-sm dark:text-gray-300 dark:bg-gray-700 focus:outline-none form-input @error('codigo') border-red-600 focus:border-red-400 focus:shadow-outline-red @endif"
                            placeholder="213749591"
                            id="codigo"
                            name="codigo"
                            value="{{ old('codigo') }}"
                        />
                    ...
                    <label class="block mt-4 text-sm">
                        ...
                        <input
                            type="password"    
                            class="block w-full mt-1 text-sm dark:text-gray-300 dark:bg-gray-700 focus:outline-none form-input @error('password') border-red-600 focus:border-red-400 focus:shadow-outline-red @endif"
                            placeholder="***************"
                            id="password"
                            name="password"
                        />
                    ...
                    <label class="block mt-4 text-sm">
                        ...
                        <input
                            type="password"    
                            class="block w-full mt-1 text-sm dark:text-gray-300 dark:bg-gray-700 focus:outline-none form-input @error('password_confirmation') border-red-600 focus:border-red-400 focus:shadow-outline-red @endif"
                            placeholder="***************"
